...
bool SensorlessEstimator::update() {
    ...
    I_alpha_beta[1] *= (float)axis_->motor_.config_.direction;
    ...
    V_alpha_beta_memory_[1] = axis_->motor_.current_control_.final_v_beta * (float)axis_->motor_.config_.direction;
